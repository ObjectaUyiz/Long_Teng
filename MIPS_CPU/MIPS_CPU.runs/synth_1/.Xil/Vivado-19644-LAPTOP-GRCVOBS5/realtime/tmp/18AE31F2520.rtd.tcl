...
set genomeRtd $env(RT_TMP)/18AE31F2520.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {MIPS_CPU_TOP__GCB0}]"
...
set genomeName [subst -nocommands -novariables {MIPS_CPU_TOP__GCB0}]
