...
set genomeRtd $env(RT_TMP)/18AF5DC7E30.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {DataMemoryFile__GB5}]"
...
set genomeName [subst -nocommands -novariables {DataMemoryFile__GB5}]
