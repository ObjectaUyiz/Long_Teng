...
namespace eval ::optrace {
  variable script "D:/Long_Teng/Long_Teng/MIPS_CPU/MIPS_CPU.runs/synth_1/MIPS_CPU_TOP.tcl"
...
synth_design -top MIPS_CPU_TOP -part xc7a35tfgg484-1
...
write_checkpoint -force -noxdef MIPS_CPU_TOP.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file MIPS_CPU_TOP_utilization_synth.rpt -pb MIPS_CPU_TOP_utilization_synth.pb"
