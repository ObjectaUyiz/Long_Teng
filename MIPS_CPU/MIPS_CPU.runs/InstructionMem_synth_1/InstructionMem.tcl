...
namespace eval ::optrace {
  variable script "D:/Long_Teng/Long_Teng/MIPS_CPU/MIPS_CPU.runs/InstructionMem_synth_1/InstructionMem.tcl"
...
set cached_ip [config_ip_cache -export -no_bom  -dir D:/Long_Teng/Long_Teng/MIPS_CPU/MIPS_CPU.runs/InstructionMem_synth_1 -new_name InstructionMem -ip [get_ips InstructionMem]]
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix InstructionMem_ InstructionMem.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ InstructionMem_stub.v
 lappend ipCachedFiles InstructionMem_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ InstructionMem_stub.vhdl
 lappend ipCachedFiles InstructionMem_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ InstructionMem_sim_netlist.v
 lappend ipCachedFiles InstructionMem_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ InstructionMem_sim_netlist.vhdl
 lappend ipCachedFiles InstructionMem_sim_netlist.vhdl
 set TIME_taken [expr [clock seconds] - $TIME_start]

 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp InstructionMem.dcp -move_files $ipCachedFiles   -synth_runtime $TIME_taken  -ip [get_ips InstructionMem]
 }
...
rename_ref -prefix_all InstructionMem_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef InstructionMem.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "InstructionMem_synth_1_synth_report_utilization_0" "report_utilization -file InstructionMem_utilization_synth.rpt -pb InstructionMem_utilization_synth.pb"
...
OPTRACE "InstructionMem_synth_1" END { }
